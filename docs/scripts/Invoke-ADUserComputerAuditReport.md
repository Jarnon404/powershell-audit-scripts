...
Audits Active Directory users and computers, including stale logons, disabled objects, lockout-related details and basic risk findings.
...
- Last logon related data
- Disabled objects
- Basic account and computer risk indicators

## Requirements

- Windows PowerShell 5.1 or newer
- ActiveDirectory PowerShell module
- Read access to Active Directory user and computer objects
