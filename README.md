...
Public-safe PowerShell audit and reporting scripts for Windows Server, Active Directory, Group Policy, Microsoft 365, Exchange Online, Microsoft Entra ID and Microsoft Intune environments.

The scripts are intended for inventory, audit, reporting, documentation and operational visibility. They are designed to be read-only by default and suitable for lab testing, controlled production review and defensive administration.
...
* Practical PowerShell audit and reporting
* Microsoft 365, Entra ID, Intune and Exchange Online administration
* Windows Server, Active Directory and Group Policy operational visibility
* HTML and CSV reporting for IT environments
* Public-safe repository hygiene
* GitHub Actions quality checks
* Pester repository tests
* PSScriptAnalyzer validation
* Secret scanning with Gitleaks
* Public safety checks for generated files and unsafe markers
...
This repository is intended for public-safe examples, documentation and read-only audit tooling. Do not add customer names, tenant IDs, internal hostnames, private IP addresses, secrets or generated customer reports.
